...
class TripController extends Controller
{
    ...
    public function show(Request $request, Trip $trip)
    {
        ...
        return response()->json(['message' => 'Cannot find this trip'], 400); 
    }
    ...
    public function accept(Request $request, Trip $trip)
    {
        ...
        $trip->update([
            ...
            'driver-location' => $request->driver_location,
        ]);
    ...
    {
        //a driver has started a taking a passemger to their destination
        $trip->update([
            'is_started' => true
        ]);
